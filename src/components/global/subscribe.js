export default function () {
    return(
        <form
        action={"https://app.convertkit.com/forms/3227214/subscriptions"}
        className="w-full bg-white rounded-md seva-form formkit-form"
        method="post"
        data-sv-form="3227214"
        data-uid="b3b86b4a38"
        data-format="inline"
        data-version="5"
      ...
      >
        <div data-style="full">
          <div data-element="column" className="formkit-column bg-gray-50">
            <div className="formkit-background opacity-30"></div>
            <div
              className="text-xl font-bold text-gray-600 formkit-header"
              data-element="header"
            >
              <h2>
                Subscribe to
            ...
            >
              <p>
                Subscribe for update from ronnapat.com
              </p>
              <span>
                  After click subscribe you need to confirm email. Sometimes it will be in spam section!
              </span>
            </div>
          </div>
          <div data-element="column" className="formkit-column">
            ...
            <div data-element="fields" className="seva-fields formkit-fields">
              <div className="formkit-field">
                <input
                  className="border-gray-200 text-black rounded formkit-input"
              ...
              <button
                data-element="submit"
                className="text-white transition bg-sky-500 formkit-submit rounded-3xl hover:bg-sky-600"
              >
            ...
            <div
              className="text-sm text-gray-600 formkit-guarantee"
              data-element="guarantee"
            >
                <p className="text-black">
                When you click Subscribe you need to agree with Privacy and Terms
              </p>
            </div>
        ...
        <style jsx>{`
          ...
          .formkit-form .formkit-spinner > div {
            ...
            border-radius: 100%;
            display: inline-block;
            -webkit-animation: formkit-bouncedelay-formkit-form-data-uid-28941d74d8-
              1.4s infinite ease-in-out both;
            animation: formkit-bouncedelay-formkit-form-data-uid-28941d74d8- 1.4s
          ...
          .formkit-form .formkit-powered-by-convertkit:hover,
          .formkit-form .formkit-powered-by-convertkit:focus {
            background-color: #ffffff;
          ...
          .formkit-form .formkit-powered-by-convertkit[data-variant="dark"],
          .formkit-form .formkit-powered-by-convertkit[data-variant="light"] {
          ...
          @-webkit-keyframes formkit-bouncedelay-formkit-form-data-uid-28941d74d8- {
            0%,
            80%,
            100% {
          ...
          @keyframes formkit-bouncedelay-formkit-form-data-uid-28941d74d8- {
            0%,
            80%,
            100% {
              -webkit-transform: scale(0);
          ...
          .formkit-form[min-width~="600"] .formkit-column,
          .formkit-form[min-width~="700"] .formkit-column,
          .formkit-form[min-width~="800"] .formkit-column {
            padding: 32px;
          }
