    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarText">
        ...
        <span class="navbar-text">
          ...
          &nbsp;&nbsp;
          <a href="https://instagram.com/ronnapatsri" target="_blank" class="black">
            <svg width="24" height="24" class="black" stroke-width="1.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          &nbsp;&nbsp;
          <a href="https://twitter.com/ronnapatp" target="_blank" class="black">
            <svg width="24" height="24" class="black" stroke-width="1.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          &nbsp;&nbsp;
          <a href="https://github.com/ronnapatp" target="_blank" class="black">
            <svg width="24" height="24" class="black" stroke-width="1.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <button class="btn btn-link black" on:click={discordCopy} title="Click here to copy ronnapat discord username">
          ...
          <a href="mailto:ronnapat.sri@gmail.com" target="_blank" class="black">
            <svg width="24" height="24" class="black" stroke-width="1.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
