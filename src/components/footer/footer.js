...
<li>
<a href="#" class="mr-4 hover:underline md:mr-6 ">Cookies</a>
</li>
</ul>
</div>
<hr class="my-6 border-gray-200 sm:mx-auto dark:border-gray-700 lg:my-8" />
<span class="block text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="https://ronnapat.com" class="hover:underline">Ronnapat Srivoravilai</a>. All Rights Reserved.
</span>
</footer>
