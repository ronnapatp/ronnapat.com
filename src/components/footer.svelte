...
<footer class="text-center container">
    ...
    <span>
        <a href="https://facebook.com/pieronnapatp" target="_blank">
          ...
          <button class="btn btn-link" on:click={discordCopy} title="Click here to copy ronnapat discord username">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"  fill="currentColor" class="bi bi-discord black" viewBox="0 0 16 16">
