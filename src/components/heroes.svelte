...
<div class="px-4 py-5 my-5 text-center">
    <img class="d-block mx-auto mb-4" src="/logo-no-bg.png" alt="" width="72" height="auto">
    <h1 class="display-5 fw-bold">Hello, I'm {fullName}</h1>
    <div class="col-lg-6 mx-auto">
      <p class="lead mb-4">I create website application and bot see my all blog at <a href="/blog" class="text-dark">blog</a> page</p>
      <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
        <a href="#skill" type="button" class="btn btn-warning btn-lg px-4 gap-3 btn-rounded">
        ...
        <a href="/blog" type="button" class="btn btn-outline-warning text-dark btn-lg px-4 btn-rounded">
          <svg width="24" height="24" stroke-width="1.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <a href="/about" type="button" class="btn btn-warning btn-lg px-4 btn-rounded">
          <svg width="24" height="24" stroke-width="1.5" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
