...
<div class="container col-xl-10 col-xxl-8 px-4 py-5">
    <div class="row align-items-center g-lg-5 py-5">
      ...
      <div class="col-md-10 mx-auto col-lg-5">
        <form class="p-4 p-md-5 fs-3 text-center border border-success rounded-3" style="background-color: #d4edda; color: #155724;">
            Message send
            <br>
            <a href="/contact" class="btn btn-success">Back to contact page</a>
        </form>
      </div>
    </div>
  </div>
