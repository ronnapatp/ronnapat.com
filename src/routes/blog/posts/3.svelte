...
<svelte:head>
    ...
    <meta property="og:url" content="https://ronnapat.com/blog/howto" />
    <meta property="og:type" content="website" />
    <meta property="og:title" content="{Name} | {fullName}" />
    <meta property="og:description" content="Because in coding they have a lot of bug so I create website that you can find the way to solve coding problem for example How to fix npm error?" />
...
<div class="container">
    <h1>{Name}</h1>
    <div>   
        <iframe src="https://www.facebook.com/plugins/like.php?href=https%3A%2F%2Fronnapat.com%2Fblog%2Fhowto&width=120&layout=button&action=like&size=small&share=true&height=65&appId=178075394515057" width="120" height="65" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share"></iframe>       
    </div>
        <img src="/blog/{image}" alt="{imagealt}"  class="img-thumbnail"  width="80%"> <br>  
    ...
    <div class="fb-comments" data-href="https://www.ronnapat.com/blog/posts/3" data-width="" data-numposts="5"></div>
