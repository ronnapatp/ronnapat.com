...
<svelte:head>
    ...
    <meta property="og:url" content="https://ronnapat.com/project/howto" />
...
<div class="container">
    <h1>{Name}</h1>
    <div>   
        <iframe src="https://www.facebook.com/plugins/like.php?href=https%3A%2F%2Fronnapat.com%2Fproject%2Fhowto&width=120&layout=button&action=like&size=small&share=true&height=65&appId=178075394515057" width="120" height="65" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share"></iframe>       
    </div>
        <img src="/project/{image}" alt="{imagealt}"  class="img-thumbnail"  width="80%"> <br>  
