...
<div class="container">
    <h1>{Name}</h1>
    <img src="/project/{image}" alt="{imagealt}" width="{imagewidth}" height="{imageheight}" > <br><br>  
    ...
    <div class="fb-comments" data-href="https://www.ronnapat.com/" data-width="600" data-numposts="5"></div></div>
</body>
<Footer />