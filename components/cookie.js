            ...
            <div className="max-w-prose mx-auto py-8 prose-h1:font-semibold prose-p:text-gray-600 prose-h2:text-2xl prose-h2:md:text-4xl prose-a:text-gray-600 hover:prose-a:text-sky-500 hover:prose-a:underline">
                ...
                <div className="mt-14" id='what-is-cookies'>
                    ...
                    <p className="mt-10">
                        ...
                        <br /><br />
                        From :
                        <a className="ml-2" href="https://www.kaspersky.com/resource-center/definitions/cookies" target='_blank'>
                          Kaspersky  
                        </a>
                    </p>
                </div>
                ...
                <div className="mt-14" id='changes-of-cookies-policy'>
                    ...
                    <p className="mt-10">
                        We may change this cookie policy from time to time, You may get update from us if we update pur cookie policy by <a href="/sub">subscribe</a>
                    </p>
                </div>
