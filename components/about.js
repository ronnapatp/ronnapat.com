          ...
          >
            ...
            >
              <div className="px-2 mb-12">
                ...
                />
                <h1 className="text-center text-3xl font-semibold mb-2 dark:text-white">
                  Ronnapat Srivoraviali
                </h1>
              </div>
              ...
              <div className="font-light text-lg px-2 mb-12">
                ...
                <a
                  href="/contact"
                  className="flex items-center my-3 dark:text-gray-200"
                >
            ...
            <div className="content w-full p-12 dark:bg-slate-600">
              <div
                id="profile"
                className="prose dark:prose-headings:text-white dark:prose-p:text-gray-200"
              >
                <h1 className="text-3xl mb-2">Ronnapat Srivoraviali</h1>
                <p>
                  Hi everyone ,Thank you for check out my personal website for
                  my information please continue reading but if you have any
                  question that don't in this page you can contact me in Contact
                  page
                </p>
              </div>
              <hr className="mt-8 mb-12" />
              <div id="experience" className="prose">
                <h2 className="section-headline text-2xl dark:text-gray-100">
                  Education :
                </h2>
