export default function Header({ name, description, button, bthref }) {
  return (
          ...
          <div className="flex flex-col items-center w-full md:flex-row">
            <div className="mt-40 mb-40 md:mb-0 md:mt-0 md:order-2">
              ...
              <div className="mt-6">
                <a
                  href={bthref}
                  className="block px-3 py-2 font-semibold text-center text-white transition-colors duration-200 transform bg-sky-500 dark:bg-sky-600 rounded-md md:inline hover:bg-sky-400 dark:hover:bg-sky-500"
                >
                  {button}
                </a>
              </div>
