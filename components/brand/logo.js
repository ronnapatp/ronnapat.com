    ...
    return(
        <div className="inline-flex space-x-5">
            <div class="block p-4 max-w-sm bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                ...
                <h1 class="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">Favicon logo (.ico)</h1>
                <p class="font-normal text-gray-700 dark:text-gray-400">Download as : <a href="/favicon.ico" download>ICO</a></p>
            </div>
