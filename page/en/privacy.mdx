...
update: '21/02/2022'
draft: false
github: 'https://github.com/ronnapatp/ronnapat.com/blob/main/page/en/privacy.mdx'
---
...
<div className="mt-14" id="cookie"></div>
...
<div className="mt-14" id="google-analytics"></div>
...
<div className="mt-14" id="contact-and-subscribe-form"></div>
...
<div className="mt-14" id="changes-of-privacy-policy"></div>
