    ...
    await sendgrid.send({
      ...
      html: `
        <div class="img-container" style="display: flex;justify-content: center;align-items: center;border-radius: 5px;overflow: hidden; font-family: 'helvetica', 'ui-sans';">
              ...
              <small class="footer" style="font-size: 7px;padding-bottom: 20px;border-bottom: 1px solid #D1D5DB;">Regards,<br>Ronnapat Srivoravilai<br>Visit website : <a href="https://ronnapat.com" target="_blank">ronnapat.com</a><br>Support : <a href="mailto:support@ronnapat.me">support@ronnapat.me</a><br><br><small style="color: #808388;">This is auto mail from ronnapat.com please don't reply this email</small></small>
              </div>
      `,
    });
  } catch (error) {
