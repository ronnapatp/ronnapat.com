...
<Layout title="I build my twitter bot to update my bio using twitter api" page="my-twitter-bot" date="08/02/2022" author="ronnapatp" image="/blog/my-twitter-bot/title.png">
