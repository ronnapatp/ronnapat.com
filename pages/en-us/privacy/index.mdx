...
<Header head="legal" title="Privacy Policy" description={`Last update : ${UpdatePrivacy }`} />
<Layout>
<br />
...
\
Have issue in this page? [Fix it on github](https://github.com/ronnapatp/ronnapat.com/edit/main/pages/en-us/privacy/index.mdx)
